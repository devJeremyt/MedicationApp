...
import com.westga.cs3211.prescription_app.model.MedicationRecordManager;
...
public class PrescriptionAppViewModel {
	...
	private MedicationRecordManager recordManager;
	...
	public PrescriptionAppViewModel() {
		...
		this.recordManager = new MedicationRecordManager();
	...
	public void removePrescription(Prescription prescription) {
		...
		this.prescriptionListProperty.set(FXCollections.observableArrayList(this.prescriptionManager.getPrescriptions()));
		this.recordManager.removePrescriptionRecord(prescription);
	}
	...
	public void confirmMedTaken(Reminder selectedItem) {
		...
		this.recordManager.addNewEvent(selectedItem);
	}
