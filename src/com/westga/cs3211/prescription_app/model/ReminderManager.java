...
public class ReminderManager {
	 ...
	 * 
	 * @precondition none
	 * @postcondition reminders and remindersBeingDisplayed are instantiated, and
	 *                the monitor Timer object is set to execute every second.
	 */
	 ...
	 * 
	 * @precondition none
	 * @postcondition the passed in medication is taken, and it is recorded in the
	 *                records.
	 *
		...
		public void run() {
			for (Reminder reminder : ReminderManager.this.reminders) {
				if (reminder.hasBeenTaken()) {
					MedicationRecordManager.addNewEvent(reminder);
